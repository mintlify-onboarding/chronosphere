...
sidebarTitle: Slack source plugin (Telemetry Pipeline)
'og:description': Use the Slack source plugin.
---
...
The Slack [source plugin](/pipeline-data/plugins/source-plugins)
(name: `http_loader`, alias: `slack`) lets you retrieve data from the Slack API
...
| --------- | --- | ----------- | ------- |
| **Token** | _none_ | Required. Your Slack API token. | _none_ |
