...
[`ListTraceJaegerRemoteSamplingStrategies`](https://docs.chronosphere.io/tooling/api-info/definition/operations/ListTraceJaegerRemoteSamplingStrategies)
endpoint.
...
To complete this action with the Chronosphere API, use the
[`CreateTraceJaegerRemoteSamplingStrategy`](https://docs.chronosphere.io/tooling/api-info/definition/operations/CreateTraceJaegerRemoteSamplingStrategy)
endpoint.
...
To complete this action with the Chronosphere API, use the
[`UpdateTraceJaegerRemoteSamplingStrategy`](https://docs.chronosphere.io/tooling/api-info/definition/operations/UpdateTraceJaegerRemoteSamplingStrategy)
endpoint.
...
To complete this action with the Chronosphere API, use the
[`DeleteTraceJaegerRemoteSamplingStrategy`](https://docs.chronosphere.io/tooling/api-info/definition/operations/DeleteTraceJaegerRemoteSamplingStrategy)
endpoint.
