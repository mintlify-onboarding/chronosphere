...
'og:description': Use the Shaping Impact Preview to preview the impact of aggregation rules on your system before applying them.
sidebarTitle: Preview rules
---
{/* -- dri: Adam Locke -- */}
