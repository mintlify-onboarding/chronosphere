...
1. In the main header next to **Logs Explorer**, click
   <Icon icon="link-simple" /> **Copy URL** and choose type of time range to use for the URL:
...
1. Expand an individual log you want to share, and then click <Icon icon="link-simple" />
