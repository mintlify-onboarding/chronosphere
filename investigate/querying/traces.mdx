...
1. To copy a short URL to your clipboard you can share with other users,
   click <Icon icon="link-simple" /> **Copy URL**. Use this capability for sharing links
...
To share your search, click <Icon icon="link-simple" /> the copy icon to copy a short URL
