...
'og:description': Learn how to use differential diagnosis to identify metrics most closely correlated with suspicious behavior.
---
...
Some panels in Observability Platform with a <Icon icon="ellipsis-vertical" /> three vertical dots menu
...
1. In any chart, click the <Icon icon="ellipsis-vertical" /> three vertical dots
...
You can pin a time range by clicking the <Icon icon="thumbtack" /> range selector pin,
...
To change how the list is sorted, click the <Icon icon="bars-sort" /> sort dropdown,
...
- **<Icon icon="magnifying-glass-plus" /> Include label** includes that label's
...
- **<Icon icon="magnifying-glass-minus" /> Exclude label** excludes that label's
...
<Icon icon="chevrons-left" /> collapse control, or resize it by clicking
...
In any **Metrics DDx** panel, click the <Icon icon="ellipsis-vertical" /> three
