...
description: Learn how to authenticate with the Chronosphere MCP server so you can interact with resources in Chronosphere Observability Platform.
---
{/* -- dri: Adam Locke -- */}
