---
title: Secrets
sidebarTitle: Secrets (Telemetry Pipeline)
...
### Core Instance [#add-secret-instance]
...
### Pipelines [#update-secret-pipeline]
...
### Core Instance [#update-secret-instance]
...
1. Run the following command to delete any previously encoded secrets, which might
   ...
   ```shell copy /INSTANCE/ /ENV/ /NAMESPACE/
