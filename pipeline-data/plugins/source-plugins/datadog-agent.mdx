---
title: Datadog Agent source plugin
sidebarTitle: Datadog Agent source plugin (Telemetry Pipeline)
'og:description': Use the Datadog Agent source plugin to ingest log data.
---
...
The Datadog Agent [source plugin](/pipeline-data/plugins/source-plugins)
(name: `http`, alias: `datadog_agent`) ingests data from Datadog into a telemetry pipeline.
