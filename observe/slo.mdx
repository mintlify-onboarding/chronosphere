...
The menu also includes a link to the <Icon path={ mdiBookOpenVariantOutline } /> documentation
and a <Icon path={ mdiDotsVertical }/> three vertical dots icon.
...
<Icon path={ mdiDotsVertical }/> three vertical dots. When clicked, this provides
