...
description: Learn about utility scores and analyzing volume for log data in Observability Platform.
---
{/* -- dri: Adam Locke -- */}
...
1. In the **Pattern Details** page, click **Create control rule for this pattern**.
   ...
   predefined.
1. Press <kbd>Ctrl+Enter</kbd> (<kbd>Command+Return</kbd> on macOS) to submit the
