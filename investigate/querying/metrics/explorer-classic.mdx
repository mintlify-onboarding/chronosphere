...
<kbd>Shift+Enter</kbd> (<kbd>Shift+Return</kbd> on macOS).
...
![Metrics menu](/doc-assets/metrics-explorer-metrics-menu.png)
...
![Split query](/doc-assets/metrics-explorer-split-button.png)
...
![Query history overview](/doc-assets/metrics-explorer-query-history.png)
