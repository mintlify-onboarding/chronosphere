---
title: Amazon Kinesis Streams destination plugin
sidebarTitle: Amazon Kinesis Streams destination plugin (Telemetry Pipeline)
'og:description': Send pipeline data to Amazon Kinesis Streams.
---
...
The Amazon Kinesis Streams [destination plugin](/pipeline-data/plugins/destination-plugins)
(name: `kinesis_streams`) lets you stream and analyze your data by sending it
directly to your Amazon Kinesis stream.
...
| **Kinesis Stream Name** | `stream` | Kinesis Stream name. | _none_ |
...
| **Kinesis Streams API Endpoint** | `endpoint` | Custom endpoint for the Kinesis API. | _none_ |
