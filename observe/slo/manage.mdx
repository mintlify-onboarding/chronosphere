...
description: Learn about creating, editing, and deleting service level objectives (SLOs) in Chronosphere Observability Platform.
---
import { ServiceNavIcon} from '@/components';
...
1. **<Icon path={ mdiContentCopy } /> Copy** the generated resource definition
   to your clipboard or **<Icon path={ mdiDownload } /> Download** it.
...
1. Click the <Icon path={ mdiDotsVertical }/> three vertical dots that appear
   in the SLO's row, and then click **Edit**.

To edit an SLO from its page, click the <Icon path={ mdiDotsVertical }/> three vertical dots
...
**<Icon path={ mdiContentCopy } /> Copy** the resource definition to your clipboard
or **<Icon path={ mdiDownload } /> Download** it.
...
You can also **<Icon path={ mdiContentCopy } /> Copy** the resource definition
to your clipboard or **<Icon path={ mdiDownload } /> Download** it.
...
1. Add **Additional filters** to reduce the number of metrics used by the SLO.
   ...
   1. Click the <Icon path={ mdiCheck } /> check icon to add the filter, or
      the <Icon path={ mdiClose } /> close icon to cancel.

   To remove a filter from the **Add label filter** field, click the
   <Icon path={ mdiCloseCircle } /> close icon on the chip that represents the
   filter.
...
- The **SLO** tab charts service availability over the selected time range.
  ...
  When you make changes to the SLO, click the **<Icon path={ mdiRefresh } /> refresh
...
1. Click the <Icon path={ mdiDotsVertical }/> three vertical dots in the SLO's
...
1. [Authenticate to the Chronosphere API](/tooling/api-info).
1. Make a request to the [`DeleteSLO`](/tooling/api-info/definition/operations/DeleteSLO)
