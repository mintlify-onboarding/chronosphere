...
description: Learn how to search and filter logs in Chronosphere Observability Platform.
---
{/* -- dri: Adam Locke -- */}
...
If you're unsure what syntax to use, click in the query box and press
     <kbd>Control+Space</kbd> to display values for a key or available operators.
</Info>
...
1. To submit your query, either click **<Icon path={ mdiRefresh } />Run** or press
...
1. To submit your query, click **<Icon path={ mdiRefresh } />Run** or press
   <kbd>Control+Enter</kbd> (<kbd>Command+Return</kbd> on macOS).
...
1. Add a full-text string to your search to narrow the scope of your query, and then
   click **<Icon path={ mdiRefresh } />Run**:
...
1. Click **<Icon path={ mdiRefresh } />Run** to run your query.
