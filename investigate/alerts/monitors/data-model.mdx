...
'og:description': Learn about the data model for monitors.
...
[in the API](https://docs.chronosphere.io/tooling/api-info/definition/operations/CreateMonitor).
...
- Chronoctl or the
  [CreateMonitor API endpoint](https://docs.chronosphere.io/tooling/api-info/definition/operations/CreateMonitor):
