...
| Icon | Description |
| ---- | ----------- |
| <Icon icon="hexagon-exclamation" color="#ee6c6cff"/> | Currently alerting monitor that exceeds the defined critical conditions. |
| <Icon icon="circle-exclamation" color="#ffb249ff"/>    | Currently alerting monitor that exceeds the defined warning conditions.  |
| <Icon icon="bell-slash" color="#c1a6f8ff" />   | Monitor that's currently muted by an active muting rule.                 |
| <Icon icon="circle-check" color="#59cc8dff"/>    | Passing monitor that's not generating alerts.                            |
