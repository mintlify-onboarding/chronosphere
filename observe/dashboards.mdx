...
'og:description': Use dashboards to create and organize data visualizations in Chronosphere Observability Platform.
...
1. Click the **<Icon icon="table-cells" alt="Dashboard icon"/> Dashboards**
   filter.
...
**<Icon icon="table-cells" alt="Dashboards"/> Dashboards**. This displays
...
[`ListDashboards`](https://docs.chronosphere.io/tooling/api-info/definition/operations/ListDashboards) endpoint.
...
To complete this action with the Chronosphere API, use the
[`CreateDashboard`](https://docs.chronosphere.io/tooling/api-info/definition/operations/CreateDashboard) endpoint.
...
1. In the navigation menu select **<Icon icon="table-cells" /> Dashboards**.
1. Click **+ Add**.
...
To complete this action with the Chronosphere API, use the
[`UpdateDashboard`](https://docs.chronosphere.io/tooling/api-info/definition/operations/UpdateDashboard) endpoint and
...
To complete this action with the Chronosphere API, use the
[`DeleteDashboard`](https://docs.chronosphere.io/tooling/api-info/definition/operations/DeleteDashboard) endpoint.
