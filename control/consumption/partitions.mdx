---
title: Partitions
sidebarTitle: Log partitions
description: Use partitions in Chronosphere Observability Platform to create slices of your data with meaningful dimensions and distinct owners.
---
