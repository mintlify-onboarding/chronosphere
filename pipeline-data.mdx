...
{/* vale Chronosphere.SentenceLengthLong = NO */}
 ...
 <Columns cols={1}>
  <Card horizontal icon="dharmachakra" title="Automated Kubernetes logging" href="/pipeline-data/automated-logging" />
  <Card horizontal icon="pipe" title="Create, modify, or delete pipelines" href="/pipeline-data/create-modify" />
  <Card horizontal icon="file-code" title="Parsers" href="/pipeline-data/parsers" />
  <Card horizontal icon="route" title="Plugins" href="/pipeline-data/plugins" />
  <Card horizontal icon="filters" title="Processing rules" href="pipeline-data/processing-rules" />
  <Card horizontal icon="bandage" title="Troubleshoot a pipeline" href="/pipeline-data/troubleshoot" />
</Columns>
