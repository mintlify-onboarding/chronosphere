...
To complete this action with the Chronosphere API, use the
[`UpdateResourcePools`](https://docs.chronosphere.io/tooling/api-info/definition/operations/UpdateResourcePools) endpoint.
...
To complete this action with the Chronosphere API, use the
[`DeleteResourcePools`](https://docs.chronosphere.io/tooling/api-info/definition/operations/DeleteResourcePools)
endpoint.
