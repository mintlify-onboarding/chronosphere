...
[`ReadOtelMetricsIngestion`](https://docs.chronosphere.io/tooling/api-info/definition/operations/ReadOtelMetricsIngestion)
endpoint.
...
[`CreateOtelMetricsIngestion`](https://docs.chronosphere.io/tooling/api-info/definition/operations/CreateOtelMetricsIngestion)
endpoint.

To update an OpenTelemetry ingestion configuration with the Chronosphere API, use the
[`UpdateOtelMetricsIngestion`](https://docs.chronosphere.io/tooling/api-info/definition/operations/UpdateOtelMetricsIngestion)
endpoint.
...
To complete this action with the Chronosphere API, use the
[`DeleteOtelMetricsIngestion`](https://docs.chronosphere.io/tooling/api-info/definition/operations/DeletedOtelMetricsIngestion)
endpoint.
