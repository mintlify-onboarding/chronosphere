...
'og:description': Optimize pipeline performance with resource profiles.
sidebarTitle: Resource profiles
---
...
```shell /INSTANCE/ /PIPELINE/ /PROFILE/
...
```shell /INSTANCE/ /PROFILE/ /FILE_NAME/
