...
description: Learn about using derived labels to standardize data in Observability Platform.
---
...
1. Click the <Icon path={ mdiDotsVertical } /> three vertical dots icon for any label
