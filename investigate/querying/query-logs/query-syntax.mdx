...
'og:description': Learn about the syntax for querying logs in Chronosphere Observability Platform.
---
{/* -- dri: Adam Locke -- */}
...
- **Run shortcut**: Run a query by pressing `Control+Enter`
...
```text /QUERY/ /AGGREGATION/ /TIME/ /EXPRESSION/
...
```text /QUERY/ /KIND/ /FIELD/ /REGEX_STRING/ /NEXT_FIELD/ /NEXT_STRING/
...
```text /QUERY/ /AGGREGATION/ /FIELD/ /EXPRESSION/
...
```text /QUERY/ /NUMBER/ /AGGREGATION/ /EXPRESSION/
...
```text /QUERY/ /OPERATOR/ /EXPRESSION/
...
```text /QUERY/ /OPERATOR/ /FIELD/ /EXPRESSION/
...
```text /QUERY/ /OPERATOR/ /COLUMN/ /EXPRESSION/
...
```text /QUERY/ /OPERATOR/ /FIELD/ /CONDITION/
...
```text /QUERY/ /AGGREGATION/ /EXPRESSION/ /NUMBER/ /TIME/ /FIELD/
...
```text /QUERY/ /OPERATOR/ /EXPRESSION/ /NUMBER/
...
```text /QUERY/ /OPERATOR/ /FIELD/ /START_INDEX/ /LENGTH/
