...
| Icon | Description |
| ---- | ----------- |
| <Icon icon="hexagon-exclamation" style={{ color: 'rgb(238, 108, 108)' }}/> | Currently alerting monitor that exceeds the defined critical conditions. |
| <Icon icon="circle-exclamation" style={{ color: 'rgb(255, 178, 73)' }}/>    | Currently alerting monitor that exceeds the defined warning conditions.  |
| <Icon icon="bell-slash" style={{ color: 'rgb(193, 166, 248)' }}/>   | Monitor that's currently muted by an active muting rule.                 |
| <Icon icon="circle-check" style={{ color: 'rgb(89, 204, 141)' }}/>    | Passing monitor that's not generating alerts.                            |
...
[`ListMonitors`](https://docs.chronosphere.io/tooling/api-info/definition/operations/ListMonitors) endpoint.
...
To complete this action with the Chronosphere API, use the
[`CreateMonitor`](https://docs.chronosphere.io/tooling/api-info/definition/operations/CreateMonitor) endpoint.
...
To complete this action with the Chronosphere API, use the
[`UpdateMonitor`](https://docs.chronosphere.io/tooling/api-info/definition/operations/UpdateMonitor) endpoint.
...
To complete this action with the Chronosphere API, use the
[`DeleteMonitor`](https://docs.chronosphere.io/tooling/api-info/definition/operations/DeleteMonitor) endpoint.
