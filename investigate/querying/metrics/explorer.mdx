...
1. In the **query field** begin typing to reveal a list of matching results, and
   either click a result or use the arrow keys and <kbd>Enter</kbd>
   (<kbd>Return</kbd> on macOS) to add it to the query.
...
1. To execute all of the entered queries, click **<Icon icon="rotate" /> Run**,
   or press <kbd>Alt+Enter</kbd> (<kbd>Command+Return</kbd> on macOS) on your
   keyboard.
...
1. Click the dropdown arrow of the **<Icon icon="rotate" /> Run** button.
