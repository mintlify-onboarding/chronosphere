...
<Columns cols={2} rowGroup="2">
  ...
  <Card icon="c" title=".NET" href="https://www.nuget.org/packages/Chronosphere.Pulumi.Chronosphere" />
  <Card icon="python" title="Python" href="https://pypi.org/project/pulumi-chronosphere/" />
</Columns>
