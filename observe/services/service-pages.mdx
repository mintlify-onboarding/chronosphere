...
- **RPC** panels visualize **Requests per second**, **Errors per second**, and
  **Duration P99** (slowest request in the 99th percentile of requests). Panels with
  ...
  alert have truncated queries. Panels with a <Icon icon="circle-exclamation" iconType="solid" color="#ee6c6cff" alt="Red warning exclamation"/>
...
|:-----------|:--------------------------------------------------------|:----------------------------------|
| Single     | <img className="my-0" src="/public/doc-assets/request-up-low.svg" alt="Single arrow icon"/>    | Change of 0% up to 5%             |
| Double     | <img className="my-0" src="/public/doc-assets/request-up-medium.svg" alt="Double arrow icon"/>  | Change greater than 5%, up to 15% |
| Triple     | <img className="my-0" src="/public/doc-assets/request-up-high.svg" alt="Triple arrow icon"/>  | Change greater than 15%           |
