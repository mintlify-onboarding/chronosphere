...
'og:description': Learn about viewing metrics in your system to understand which are used most and least.
sidebarTitle: Metrics usage
---
...
[`ListMetricUsagesByLabelName`](https://docs.chronosphere.io/tooling/api-info/state_definition/operations/ListMetricUsagesByLabelName)
or [`ListMetricUsagesByMetricName`](https://docs.chronosphere.io/tooling/api-info/state_definition/operations/ListMetricUsagesByMetricName)
endpoints.
...
<Frame>
![A high volume](/public/doc-assets/usage-profiler-high-unique-values.png)
</Frame>
