...
'og:description': An explanation of Chronosphere service accounts and usage.
...
[`ListServiceAccounts`](https://docs.chronosphere.io/tooling/api-info/definition/operations/ListServiceAccounts) endpoint.
...
To complete this action with the Chronosphere API, use the
[`CreateServiceAccount`](https://docs.chronosphere.io/tooling/api-info/definition/operations/CreateServiceAccount) endpoint
...
To complete this action with the Chronosphere API, use the
[`DeleteServiceAccount`](https://docs.chronosphere.io/tooling/api-info/definition/operations/DeleteServiceAccount) endpoint.
