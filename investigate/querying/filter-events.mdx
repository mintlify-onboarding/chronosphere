...
Change event categories are case sensitive, and must be all lowercase when
     ...
     press <kbd>Control+Space</kbd> to display all available attributes.

1. Click **Run**, or press <kbd>Shift+Enter</kbd> (<kbd>Shift+Return</kbd> on
...
1. Click the <Icon path={ mdiDotsVertical } /> three vertical dots icon.
