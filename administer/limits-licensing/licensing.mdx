...
| F1         | <Icon iconType="solid" icon="hexagon-exclamation" color="#ee6c6cff" alt="Rejected"/> | Time series F isn't in the bucket, and the bucket is at capacity, so data point F1 is rejected. |
...
| Data point | Status                               | Description                          |
|------------| ------------------------------------ | ------------------------------------ |
| A1         | <Icon iconType="solid" icon="hexagon-exclamation" color="#ffb249ff" alt="Expired"/> | Data point A1 expired, so it's excluded from the bucket. |
| D1         | <Icon iconType="solid" icon="hexagon-exclamation" color="#ffb249ff"  alt="Expired"/> | Data point A1 expired, so it's excluded from the bucket. |
| C1         | <Icon iconType="solid" icon="hexagon-exclamation" color="#ffb249ff"  alt="Expired"/> | Data point C1 is expiring, so it's excluded from the bucket. |
