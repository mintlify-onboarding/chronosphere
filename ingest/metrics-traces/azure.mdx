...
'og:description': Learn how to ingest Azure metrics into Chronosphere Observability Platform.
---
...
[Chronosphere API for Azure metrics](https://docs.chronosphere.io/tooling/api-info/definition/operations/ListAzureMetricsIntegrations).
...
[`ListAzureMetricsIntegrations`](https://docs.chronosphere.io/tooling/api-info/definition/operations/ListAzureMetricsIntegrations)
endpoint.

To view a single Azure metrics integration with the Chronosphere API, use
the [`ReadAzureMetricsIntegration`](https://docs.chronosphere.io/tooling/api-info/definition/operations/ReadAzureMetricsIntegration)
endpoint.
...
[`CreateAzureMetricsIntegration`](https://docs.chronosphere.io/tooling/api-info/definition/operations/CreateAzureMetricsIntegration)
endpoint.

To update a single Azure integration with the Observability Platform API, use
the [`UpdateAzureMetricsIntegration`](https://docs.chronosphere.io/tooling/api-info/definition/operations/UpdateAzureMetricsIntegration)
endpoint.
...
[`DeleteAzureMetricsIntegration`](https://docs.chronosphere.io/tooling/api-info/definition/operations/DeleteAzureMetricsIntegration)
endpoint.
