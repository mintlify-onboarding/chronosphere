...
[`ListDatasets`](https://docs.chronosphere.io/tooling/api-info/definition/operations/ListDatasets)
endpoint.
...
To complete this action with the Chronosphere API, use the
[`CreateDataset`](https://docs.chronosphere.io/tooling/api-info/definition/operations/CreateDataset)
endpoint.
...
To complete this action with the Chronosphere API, use the
[`UpdateDataset`](https://docs.chronosphere.io/tooling/api-info/definition/operations/UpdateDataset) endpoint.
...
To complete this action with the Chronosphere API, use the
[`DeleteDataset`](https://docs.chronosphere.io/tooling/api-info/definition/operations/DeleteDataset) endpoint.
