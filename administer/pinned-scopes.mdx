...
description: Learn how to configure pinned scopes in Observability Platform.
---
{/* -- dri: Lynette Miles -- */}
...
1. Click **<Icon path={mdiPlus } /> Create**.
...
1. Click the <Icon path={ mdiDotsVertical } /> three vertical dots icon in the
