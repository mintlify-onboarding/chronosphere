...
| Icon                                      | Description |
| :---------------------------------------: | ----------- |
| <Icon path={ mdiAccount} />             | An active user account. |
| <Icon path={ mdiRobot } />              | A service account. |
| <Icon path={ mdiMinusCircleOutline } /> | An invited user who's yet to confirm their account. |
| <Icon path={ mdiCloseCircleOutline } /> | A deactivated user account. |
