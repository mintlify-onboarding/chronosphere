...
'og:description': Use log control rules to define actions for a subset of your log data that match specific criteria.
sidebarTitle: Control logs
---
...
[`ReadLogControlConfig`](https://docs.chronosphere.io/tooling/api-info/definition/operations/ReadLogControlConfig)
endpoint.
...
To complete this action with the Chronosphere API, use the
[`CreateLogControlConfig`](https://docs.chronosphere.io/tooling/api-info/definition/operations/CreateLogControlConfig)
endpoint.
...
To complete this action with the Chronosphere API, use the
[`UpdateLogControlConfig`](https://docs.chronosphere.io/tooling/api-info/definition/operations/UpdateLogControlConfig)
endpoint.
...
To complete this action with the Chronosphere API, use the
[`DeleteLogControlConfig`](https://docs.chronosphere.io/tooling/api-info/definition/operations/DeleteLogControlConfig)
endpoint.
