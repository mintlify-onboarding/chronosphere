...
**<Icon icon="arrow-rotate-right" alt="Refresh icon"/> Refresh** the preview to update
...
<Icon iconType="solid" icon="check" color="#60E684"/> green checkmark next to the name.
