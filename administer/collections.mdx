...
[`ListCollections`](https://docs.chronosphere.io/tooling/api-info/definition/operations/ListCollections) endpoint.
...
To complete this action with the Chronosphere API, use the
[`CreateCollection`](https://docs.chronosphere.io/tooling/api-info/definition/operations/CreateCollection) endpoint.
...
To complete this action with the Chronosphere API, use the
[`UpdateCollection`](https://docs.chronosphere.io/tooling/api-info/definition/operations/UpdateCollection) endpoint.
...
To complete this action with the Chronosphere API, use the
[`DeleteCollection`](https://docs.chronosphere.io/tooling/api-info/definition/operations/DeleteCollection) endpoint.
