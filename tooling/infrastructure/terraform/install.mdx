...
import { DynamicCode, Link} from '@/components';
...
1. Download the `darwin_amd64` build of `chronotf`:
   ...
   <code class="chrono-code break-words rounded-md border border-black border-opacity-[0.04] bg-black bg-opacity-[0.03] px-[.25em] py-0.5 text-[.9em] dark:border-white/10 dark:bg-white/10">curl -LO {chronotfMacOSIntelLink}</code>

1. Make the `chronotf` binary executable.

   <code class="chrono-code break-words rounded-md border border-black border-opacity-[0.04] bg-black bg-opacity-[0.03] px-[.25em] py-0.5 text-[.9em] dark:border-white/10 dark:bg-white/10">chmod +x {chronotfMacOSIntel}</code>

1. Move the binary into your `PATH`:

   <code class="chrono-code break-words rounded-md border border-black border-opacity-[0.04] bg-black bg-opacity-[0.03] px-[.25em] py-0.5 text-[.9em] dark:border-white/10 dark:bg-white/10">sudo mv {chronotfMacOSIntel} /usr/local/bin/chronotf</code>
...
1. Download the `darwin_arm64` build of `chronotf`:
   ...
   <code class="chrono-code break-words rounded-md border border-black border-opacity-[0.04] bg-black bg-opacity-[0.03] px-[.25em] py-0.5 text-[.9em] dark:border-white/10 dark:bg-white/10">curl -LO {chronotfMacOSARMLink}</code>

1. Make the `chronotf` binary executable:

   <code class="chrono-code break-words rounded-md border border-black border-opacity-[0.04] bg-black bg-opacity-[0.03] px-[.25em] py-0.5 text-[.9em] dark:border-white/10 dark:bg-white/10">chmod +x {chronotfMacOSARM}</code>

1. Move the binary into your `PATH`:

   <code class="chrono-code break-words rounded-md border border-black border-opacity-[0.04] bg-black bg-opacity-[0.03] px-[.25em] py-0.5 text-[.9em] dark:border-white/10 dark:bg-white/10">sudo mv {chronotfMacOSARM} /usr/local/bin/chronotf</code>
...
1. Download the `linux_amd64` build of `chronotf`:
   ...
   <code class="chrono-code break-words rounded-md border border-black border-opacity-[0.04] bg-black bg-opacity-[0.03] px-[.25em] py-0.5 text-[.9em] dark:border-white/10 dark:bg-white/10">curl -LO {chronotfLinuxLink}</code>

1. Make the `chronotf` binary executable:

   <code class="chrono-code break-words rounded-md border border-black border-opacity-[0.04] bg-black bg-opacity-[0.03] px-[.25em] py-0.5 text-[.9em] dark:border-white/10 dark:bg-white/10">chmod +x {chronotfLinux}</code>

1. Move the binary into your `PATH`:

   <code class="chrono-code break-words rounded-md border border-black border-opacity-[0.04] bg-black bg-opacity-[0.03] px-[.25em] py-0.5 text-[.9em] dark:border-white/10 dark:bg-white/10">mv {chronotfLinux} /usr/local/bin/chronotf</code>
