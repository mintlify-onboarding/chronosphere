...
[`ListMappingRules`](https://docs.chronosphere.io/tooling/api-info/definition/operations/ListMappingRules) endpoint.
...
To complete this action with the Chronosphere API, use the
[`CreateMappingRule`](https://docs.chronosphere.io/tooling/api-info/definition/operations/CreateMappingRule) endpoint.
...
To complete this action with the Chronosphere API, use the
[`DeleteMappingRule`](https://docs.chronosphere.io/tooling/api-info/definition/operations/DeleteMappingRule) endpoint.
