...
[`ListDropRules`](https://docs.chronosphere.io/tooling/api-info/definition/operations/ListDropRules) endpoint.
...
[`CreateDropRule`](https://docs.chronosphere.io/tooling/api-info/definition/operations/CreateDropRule) endpoint,
...
[CreateDropRule API](https://docs.chronosphere.io/tooling/api-info/definition/operations/CreateDropRule) drops any
...
To complete this action with the Chronosphere API, use the
[`UpdateDropRule`](https://docs.chronosphere.io/tooling/api-info/definition/operations/UpdateDropRule) endpoint and update
...
To complete this action with the Chronosphere API, use the
[`DeleteDropRule`](https://docs.chronosphere.io/tooling/api-info/definition/operations/DeleteDropRule) endpoint.
