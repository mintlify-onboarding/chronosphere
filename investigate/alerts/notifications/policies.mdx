...
'og:description': View and create notification policies with Chronosphere Observability Platform, Chronoctl, or Terraform.
sidebarTitle: Notification policies
---
...
[`ListNotificationPolicies`](https://docs.chronosphere.io/tooling/api-info/definition/operations/ListNotificationPolicies)
endpoint.
...
To complete this action with the Chronosphere API, use the
[`CreateNotificationPolicy`](https://docs.chronosphere.io/tooling/api-info/definition/operations/CreateNotificationPolicy)
endpoint.
...
To complete this action with the Chronosphere API, use the
[`UpdateNotificationPolicy`](https://docs.chronosphere.io/tooling/api-info/definition/operations/UpdateNotificationPolicy)
endpoint.
...
To complete this action with the Chronosphere API, use the
[`DeleteNotificationPolicy`](https://docs.chronosphere.io/tooling/api-info/definition/operations/DeleteNotificationPolicy)
endpoint.
