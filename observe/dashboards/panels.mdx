...
- **<Icon icon="link-simple" alt="Link icon"/> Links**: An icon that reveals any links
  configured for the panel.
- **<Icon icon="up-right-and-down-left-from-center" alt="Expand arrow icon"/> Expand**: Expands the
...
1. Click **<Icon icon="chart-column" alt="Panel icon"/> Panel**.
