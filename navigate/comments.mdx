...
'og:description': Learn about how to use comments in Chronosphere Observability Platform to identify important data.
---
...
- **<Icon icon="link-simple" /> link**: Copy a link to a comment.
...
- **<Icon icon="arrow-rotate-right" /> refresh**: Reopen a resolved comment.
