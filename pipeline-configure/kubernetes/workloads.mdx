---
title: Workloads
description: Learn about different workload types in Chronosphere Telemetry Pipeline.
---
...
```shell copy /INSTANCE/ /PIPELINE/ /WORKLOAD/
...
```shell copy /CLASS/ /POLICY1/ /POLICY2/
--storage-class CLASS \
