---
title: Teams
'og:description': Chronosphere Observability Platform lets you create and manage teams, assign roles, and set permissions for effective collaboration.
sidebarTitle: Teams
---
...
[`CreateTeam`](https://docs.chronosphere.io/tooling/api-info/definition/operations/CreateTeam) endpoint.
...
To complete this action with the Chronosphere API, use the
[`UpdateTeam`](https://docs.chronosphere.io/tooling/api-info/definition/operations/UpdateTeam) endpoint.
...
To complete this action with the Chronosphere API, use the
[`DeleteTeam`](https://docs.chronosphere.io/tooling/api-info/definition/operations/DeleteTeam) endpoint.
