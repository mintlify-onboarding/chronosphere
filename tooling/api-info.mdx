...
For a full list of Chronosphere API endpoints, see:
 ...
 <Columns cols={1}>
  <Card horizontal icon="cards" title="Config endpoints - Create and manage Observability Platform resources" href="/tooling/api-info/definition" />
  <Card horizontal icon="book-pen" title="Data endpoints - Read and write data to Observability Platform" href="/tooling/api-info/data_definition" />
  <Card horizontal icon="check" title="State endpoints - Access the runtime state of Observability Platform" href="/tooling/api-info/state_definition" />
</Columns>
