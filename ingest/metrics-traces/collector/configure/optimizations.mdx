...
![Graph showing the compression gains of roughly 2.5 more when using zstd over snappy as the default compression algorithm](/doc-assets/collector-zstd-compression.png)
