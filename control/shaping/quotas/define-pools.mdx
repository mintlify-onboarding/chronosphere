...
sidebarTitle: Define pools
'og:description': Learn about metric pool concepts and how to apply them to help shape defining a metric pool.
---
...
See the
[CreateResourcePools endpoint](https://docs.chronosphere.io/tooling/api-info/definition/operations/CreateResourcePools)
...
[`CreateResourcePools`](https://docs.chronosphere.io/tooling/api-info/definition/operations/CreateResourcePools)
