...
import { PipeIcon } from '/snippets/Icons.jsx';
...
{/* markdownlint-disable MD013 */}
 ...
 <Columns cols={1}>
  <Card horizontal icon="screwdriver-wrench" title="Install - Set up Telemetry Pipeline in Linux and Kubernetes" href="/pipeline-install" />
  <Card horizontal icon={<PipeIcon/>} title="Create and modify pipelines - Deploy custom pipelines to collect and disseminate data" href="/pipeline-data/create-modify" />
  ...
  <Card horizontal icon="rectangle-terminal" title="Pipeline CLI - Manage pipelines through a command-line interface" href="pipeline-cli" />
</Columns>
