...
[`ListDerivedMetric`](https://docs.chronosphere.io/tooling/api-info/definition/operations/ListDerivedMetric) endpoint.
...
To complete this action with the Chronosphere API, use the
[`CreateDerivedMetric`](https://docs.chronosphere.io/tooling/api-info/definition/operations/CreateDerivedMetric) endpoint.
...
To complete this action with the Chronosphere API, use the
[`DeleteDerivedMetric`](https://docs.chronosphere.io/tooling/api-info/definition/operations/DeleteDerivedMetric) endpoint.
